...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO menu(menu_name,custom_slug) VALUES ('$menu_name','$custom_slug')";
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" name="menu_name" placeholder="" required>
              ...
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="" name="custom_slug" placeholder="" value=""required>
