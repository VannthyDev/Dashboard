...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pages(page_name,page_title,base_slug,page_description) VALUES ('$P_Name','$P_Title','$Base_slug','$Page_Description')";
      ...
      <div class="card-content">
        <form action="" method="POST">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" name="page_name" placeholder="" required>
              ...
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="" name="page_title" placeholder="" value=""required>
                  <span class="icon left"><i class="mdi mdi-mail"></i></span>
          ...
          <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="" name="base_slug" placeholder="">
                  <span class="icon left"><i class="mdi mdi-mail"></i></span>
                </div>
              </div>
              ...
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="" name="page_description" placeholder="" >
                  <span class="icon left"><i class="mdi mdi-mail"></i></span>
                </div>
              </div>
