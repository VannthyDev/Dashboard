...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <a href="addUser.php"><button class="button green">Add User</button></a> 
  </div>
</section>
          ...
          <?php
            ...
            <td class='actions-cell'>
              <div class='buttons left nowrap'>
                <a href="editUser.php?user_id=<?php echo $row['user_id'] ?>" button  class='button small blue --jb-modal'   type='button'>
                  <span class='icon'><i class='mdi mdi-fountain-pen-tip'></i></span>
                </a>
                <a href="deleteUser.php?user_id=<?php echo $row['user_id']?>" button class='button small red --jb-modal'  type='input'>
