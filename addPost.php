...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO post(post_name,post_title,article,post_css) VALUES ('$PName','$PTitle','$Article','$PCss')";
      ...
      <div class="card-content">
        <form action="" method="POST">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" name="post_name" placeholder="" required>
              ...
              <div class="field">
                <div class="control icons-left icons-right">
                  <input class="input" type="" name="post_title" placeholder="" value=""required>
          ...
          <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="" name="article" placeholder="">
          ...
          <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="" name="post_css" placeholder="">
